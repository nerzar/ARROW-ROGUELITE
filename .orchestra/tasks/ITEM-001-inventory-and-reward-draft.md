...
- Bow реально спасает бой, где нет стрел нужной стороны, и стоит ход; Стрела создаёт боеприпас на доске;
...
- Правило пользователя (2026-09-19, 2-я итерация): вместо мгновенного «+3 HP» — **Зелье** (расходник в
  инвентаре, +1 заряд за награду, до 3); новый расходник **Стрела** (до 5 зарядов, +2 за награду): кладёт на
  доску свободную стрелу в выбранном направлении (2 клетки, на плотной доске — 1 клетка; всегда с чистым
  лучом до края, поэтому не ломает решаемость). Фляга удалена. Draft: золото · зелье (если ранен) или
  Rotate · редкий предмет 30 % / стрелы ×2 35 % / двойное золото. Расходники стакуются в один слот.
- Несколько способностей у врага: `EnemyDef.abilities[]` (каждая на своём таймере). Матрона во всех 4
  боях: лечение + камни детей (`stone_throw`/3). HUD показывает строку на каждую способность.
- Тест честности переведён на правило «с базовым набором»: у каждого Act I stage есть линия без Rotate,
  где Лук+Щит покрывают весь урон; 15 из 17 обычных боёв по-прежнему проходимы в 0 и голыми руками
  (14 «Стена щитов» и 17 «Королевская стража» — с набором).
