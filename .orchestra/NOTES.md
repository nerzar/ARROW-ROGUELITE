...
### N-014 — Поздняя сложность может требовать дополнительных сил
STATUS: AGREED FOR EXPLORATION

Суть: не считать правилом, что каждый encounter всегда обязан быть решаем базовым набором. Позднее часть контента может быть рассчитана на boosters, run items, meta progression или дополнительные способности. При этом такие силы должны иметь не только платный путь получения: регулярные активности, внутриигровая валюта, rewarded ads и другие бесплатные/earned источники также рассматриваются.
Подтвердил: USER — прямо отверг правило «всегда решаем без бонусов» и предложил уровни, которые позднее требуют собранных/заработанных/купленных сил.

### N-015 — Монетизация должна встраиваться в run, а не ломать пролог
STATUS: AGREED FOR EXPLORATION

Суть: кандидаты для VK-монетизации — дополнительная способность/шмотка/charge на текущий run, revive, reroll, временный relic и похожие понятные усиления. Ранний onboarding не должен неожиданно становиться платёжным gate; момент первого monetization pressure нужно проектировать отдельно и проверять на удержании.
Подтвердил: USER — считает систему дополнительных сил естественной точкой для доната/активностей, но отдельно отметил риск «не отпугнуть игроков раньше времени».

### N-016 — Техническую базу не копировать из закрытой игры
STATUS: RESEARCH / ARCHITECTURE HYPOTHESIS

Суть: закрытые VK-игры использовать как поведенческие референсы. Для кода искать только явно лицензированные open-source реализации. Текущий стек-кандидат: Phaser 4 + TypeScript + Vite; puzzle generator/solver можно независимо реализовать или портировать из MIT-источников после отдельного аудита. Подробности: `docs/TECH-FOUNDATION-OPTIONS.md`.
Подтвердил: не утверждено пользователем как финальный стек.
