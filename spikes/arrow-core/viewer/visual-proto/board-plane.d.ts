...
export declare function fitGrid(cols: number, rows: number): GridFit

export declare function planeCornersPx(stageW: number, stageH: number): PlaneCorners

export interface BoardPlane { corners: PlaneCorners; H: Homography }
export declare function createBoardPlane(stageW: number, stageH: number): BoardPlane
